...
@injectable()
export class GenerateDeclaration {
  ...
  public async initialize() {
    ...
    const tsConfigFileContent = await readFile(path.resolve(projectDirectory, "./tsconfig.json"));
...
IOCContainer.bind(GenerateDeclaration).toSelf().inRequestScope();
